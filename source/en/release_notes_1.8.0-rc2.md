...
# [[PRODUCTNAME]] 1.8.0-rc2 - Codename "Tempel"

Welcome to the release notes for the second release candidate in the 1.8 Series of
...
[GitHub](https://github.com/xibosignage/xibo-cms/releases/tag/1.8.0-rc2).

## Requirements

We recommend running [[PRODUCTNAME]] on [Docker](install_docker.html).
...
We recommend using the 1.8.0-rc2 Windows Player with this release. The 1.7.6 or
...
Project
Page](https://github.com/xibosignage/xibo/issues?q=milestone%3A1.8.0-rc2+is%3Aclosed).
