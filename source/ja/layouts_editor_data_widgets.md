...
maxHeadingLevel: 3
minHeadingLevel: 2
excerpt: "データ ウィジェットを使用して魅力的なレイアウトを作成する"
keywords: "ウィジェット、データ ウィジェット、要素、データ要素、グローバル要素、グループ化要素、ステンシル、フォールバック データ、HTML テンプレート、CSS テンプレート、JavaScript テンプレート、カスタム テンプレート"
