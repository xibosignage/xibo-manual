...
maxHeadingLevel: 3
minHeadingLevel: 2
excerpt: "レイアウトは、コンテンツで構成された完全な画面デザインであり、ディスプレイにスケジュールされます"
keywords: "レイアウトの追加、xibo exchange、テンプレートの使用、解決策、チェックアウト、レイアウトのプレビュー、ドラフトレイアウトのプレビュー、キャンペーンへの割り当て、レイアウトの廃止、レイアウトのエクスポート、公開 "
